...
func matches(player_is_batting: bool, intent: int, ball: int, field_mode: int = FieldPlan.Mode.NEUTRAL) -> bool:
	...
	return side_ok and intent_ok and ball_ok and field_ok
